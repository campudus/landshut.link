...
h.css("background","rgb("+f[0]+","+f[1]+","+f[2]+")"):h.css("background","rgba("+f[0]+","+f[1]+","+f[2]+","+c+")")}function v(){w=e;d.find(".kolorArea").stop();d.find(".kolorArea").css("top",o+"px");d.find(".kolorArea").css("left",s+"px")}function x(){w=n;d.find(".kolorArea").stop();d.find(".kolorArea").css("top",y+"px");d.find(".kolorArea").css("left",z+"px")}function E(){var b=d.find(".kolorArea"),c=a.area_width,h=a.area_height;"percent"==a.area_width_unit?c=f/100*c-a.margin_x-2*a.area_border_width:
...
a.close_text)+'" />');if(a.close_displayed===e||a.display_title===e)c+="</div>";c+='<div class="kolorAreaContent loading"></div></div>';a.overlay_displayed===e&&(c+='<div class="kolorAreaOverlay"></div>');jQuery("#"+r).prepend(c+"</div>");d=jQuery("#"+B);D(a.background_color,a.background_alpha);var h=a.topleft_radius,f=a.topright_radius,g=a.bottomright_radius,k=a.bottomleft_radius,l=a.area_border_width,o=a.area_border_color,c=a.area_border_style,q=a.area_border_alpha,i=d.find(".kolorArea");i.css("-moz-border-radius-topleft",
h+"px");i.css("border-top-left-radius",h+"px");i.css("-webkit-border-top-left-radius",h+"px");i.css("-moz-border-radius-topright",f+"px");i.css("border-top-right-radius",f+"px");i.css("-webkit-border-top-right-radius",f+"px");i.css("-moz-border-radius-bottomright",g+"px");i.css("border-bottom-right-radius",g+"px");i.css("-webkit-border-bottom-right-radius",g+"px");i.css("-moz-border-radius-bottomleft",k+"px");i.css("border-bottom-left-radius",k+"px");i.css("-webkit-border-bottom-left-radius",k+"px");
i.css("border-width",l+"px");h=ktools.Color.hex2rgb(o);"Explorer"==kolorBrowserDetect.browser&&9>kolorBrowserDetect.version?i.css("border-color","rgb("+h[0]+","+h[1]+","+h[2]+")"):i.css("border-color","rgba("+h[0]+","+h[1]+","+h[2]+","+q+")");i.css("border-style",c);c=a.padding;q=d.find(".kolorAreaContent");a.display_title===e||a.close_displayed===e?(i=d.find(".kolorAreaHeader"),i.css("margin",c+"px 0 5px "+c+"px"),i.css("padding-right",c+"px"),i=d.find(".kolorAreaCloseBtn"),i.css("top",c+"px"),i.css("right",
c+"px"),q.css("margin","0 0 "+c+"px "+c+"px")):q.css("margin",c+"px 0 "+c+"px "+c+"px");q.css("padding-right",c+"px");c=a.title_color;q=a.title_font;i=a.title_weight;h=a.title_size;f=a.title_decoration;a.display_title===e&&(g=d.find(".kolorArea .kolorAreaTitle"),g.css("color","#"+c),g.css("font-family",'"'+q+'", sans-serif'),g.css("font-weight",i),g.css("font-size",h+"px"),"mobile"==a.device&&g.css("font-size",h-2+"px"),g.css("text-decoration",f));a.close_on_click&&d.find(".kolorArea").bind("click",
O);L===n&&(jQuery(window).bind("resize",N),L=e);I();E();H();F();G();x();C();M();A=e}if(a.refresh_content||b===n)this.c(a.refresh_content?e:n);p="open";this.q([a.animation]);a.animation||v();(a.refresh_content||b===n)&&a.open_callback&&ktools.Code.eval(a.open_callback)};this.closeKolorArea=this.b=function(){"open"==p&&(p="close",this.m([a.animation]),a.animation||x(),a.close_callback&&ktools.Code.eval(a.close_callback))};this.showKolorArea=this.q=function(b){d.show();b&&Boolean(b[0]===e||"true"===
b[0]||1===parseInt(b[0])||"yes"===b[0]||"on"===b[0])===e?(d.find(".kolorArea").stop(),d.find(".kolorArea").animate({top:o,left:s},a.animation_duration)):w==n&&v();p="open"};this.hideKolorArea=this.m=function(b){b&&Boolean(b[0]===e||"true"===b[0]||1===parseInt(b[0])||"yes"===b[0]||"on"===b[0])===e?(d.find(".kolorArea").stop(),d.find(".kolorArea").animate({top:y,left:z},a.animation_duration,function(){setTimeout(function(){d.hide()},100)})):d.hide();p="close"};this.updateKolorArea=this.z=function(a){a!=
j&&"undefined"!=typeof a&&a[0]!=j&&this.o(a[0]);this.c(e)};this.updateContent=this.c=function(b){if("null"!=t){d.find(".kolorAreaContent").addClass("loading");d.find(".kolorAreaContent").scrollTop(0);var c="",c=b?a.use_i18n?ktools.I18N.getInstance().getMessage(t):ktools.String.decode(t):ktools.String.decode(t);d.find(".kolorAreaContent").html(c);d.find(".kolorAreaContent").removeClass("loading")}};this.updateBackgroundColor=this.w=function(b){"undefined"!=typeof b[0]&&(a.background_color=b[0]);"undefined"!=
typeof b[1]&&(a.background_alpha=b[1]);D(a.background_color,a.background_alpha)};this.changeTitle=this.l=function(b){""!=a.title||"undefined"!=typeof b[0]&&""!=b[0]?(this.p({title:b[0]}),d.find(".kolorAreaTitle").html(a.use_i18n?ktools.I18N.getInstance().getMessage(a.title):a.title),d.find(".kolorAreaTitle").css("margin-left","2px")):d.find(".kolorAreaTitle").html("")}};KolorArea.A={C:"vertical",B:"horizontal"};
KolorArea.a={j:"topleft",e:"top",k:"topright",i:"right",h:"bottomright",f:"bottom",g:"bottomleft",d:"left",r:"center"};})();